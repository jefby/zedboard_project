...
-- Date:              Tue Apr 03 09:34:38 2012 (by Create and Import Peripheral Wizard)
...
begin
  ...
  rp_instance : rp
	port map (
		ain => slv_reg0(7 downto 0),
		bin => slv_reg1(7 downto 0),
		ain_vio => ain_vio,
		bin_vio => bin_vio,
		sel => sel,
		Clk => Bus2IP_Clk,
  ...
  begin
    ...
    case slv_reg_read_sel is
      when "10" => slv_ip2bus_data <= (x"00000" & "000" & result);
      when "01" => slv_ip2bus_data <= (x"00000" & "000" & result);
